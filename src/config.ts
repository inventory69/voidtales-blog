export const SITE = {
  website: "https://blog.voidtales.win/", // replace this with your deployed domain
  author: "inventory69",
  profile: "https://dettmer.dev/",
  ...
  editPost: {
    enabled: true,
    text: "Edit page",
    url: "https://github.com/inventory69/voidtales-blog/edit/main/",
  },
  dynamicOgImage: true,
  dir: "ltr", // "rtl" | "auto"
